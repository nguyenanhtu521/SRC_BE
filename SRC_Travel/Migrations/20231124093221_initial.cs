        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChargePercent = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgeRanges", x => x.AgeRangeID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Customers_AgeRanges_AgeRangeID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PriceLists_AgeRanges_AgeRangeID",
                        column: x => x.AgeRangeID,
                        principalTable: "AgeRanges",
                        principalColumn: "AgeRangeID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PriceLists_BusTypes_BusTypeID",
                        column: x => x.BusTypeID,
                        principalTable: "BusTypes",
                        principalColumn: "BusTypeID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TicketCounterID = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CancelDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingsHistories", x => x.BookingHistoryID);
                    table.ForeignKey(
                        name: "FK_BookingsHistories_Bookings_BookingID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_StartStopID",
                table: "Bookings",
                column: "StartStopID");

            migrationBuilder.CreateIndex(
                name: "IX_BookingsHistories_BookingID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_AgeRangeID",
                table: "Customers",
                column: "AgeRangeID");

            migrationBuilder.CreateIndex(
                name: "IX_PriceLists_AgeRangeID",
                table: "PriceLists",
                column: "AgeRangeID");

            migrationBuilder.CreateIndex(
                name: "IX_PriceLists_BusTypeID",
                table: "PriceLists",
                column: "BusTypeID");
